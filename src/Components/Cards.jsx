...
const Sidebar = ({ isOpen, onClose, activeItem, onItemClick }) => {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
{/* CHANGED: Replaced lg:relative with lg:sticky and lg:top-6 */}
        ...
        >
            ...
            <div className="bg-white rounded-xl lg:rounded-2xl shadow-inner relative">
                ...
                <div className="h-32 sm:h-36 lg:h-44 flex items-center justify-center -mt-1 sm:-mt-2 mb-3 sm:mb-4 relative">
                    <div className={`bg-white p-2 sm:p-3 rounded-xl lg:rounded-2xl shadow-lg transition-all duration-300 ${isHovered ? 'shadow-2xl scale-105' : ''
                        }`}>
                        <img
                            src={product.img}
                            alt={product.title}
            ...
            {/* Add to cart button */}
            <div className={`absolute left-1/2 -translate-x-1/2 bottom-3 sm:bottom-4 transition-all duration-300 ${isHovered || window.innerWidth < 1024 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'
                }`}>
                <button
                    onClick={handleAdd}
                    className="bg-[#A16341] hover:bg-[#8B5232] active:bg-[#8B5232] text-white px-3 sm:px-4 lg:px-6 py-2 sm:py-2.5 lg:py-3 rounded-full flex items-center gap-1.5 sm:gap-2 shadow-lg hover:shadow-xl transition-all duration-200 font-medium text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#A16341]/30 touch-manipulation active:scale-95 ml-20"
                >
                    ...
                    <div className="flex-1 lg:col-span-9">
                        ...
                        {filteredProducts.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-12 text-center">
                                <div className="text-6xl mb-4"><HashLoader
  color="#BF6519"
  size={400}
  speedMultiplier={0.9}
/></div>
